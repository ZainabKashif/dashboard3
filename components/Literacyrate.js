...
const PieChart2Component = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://10.0.2.2:4000/api/literacy-rate');
    ...
    return (
        ...
        <View
            ...
            <View
                ...
                <Text style={{ color: 'white', fontSize: 18, fontWeight: 'bold', textAlign: 'center' }}>Literacy Rates</Text>
